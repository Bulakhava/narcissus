   ...
   public function __construct($page, $perpage, $total)
   {
    ...
    public function getHtml(){
       ...
       if($this->currentPage + 2 <= $this->countPages){
        ...
        return ($this->countPages > 1) ? '<ul class="pagination">' .$startpage.$back.$page2left.$page1left . '<li><a class="nav-link active" href="">'. $this->currentPage .'</a></li>' .$page1right.$page2right.$forward.$endpage . '</ul>' : null  ;
   }
